...
- *What should I do with data?* Data should be used responsibly and ideally for the benefit of people and society.
...
- *Publish:* share dashboards online.
...
Data visualization means presenting data visually so people can understand patterns more quickly. It is not only decoration; it is also a method of analysis.
...
- *Where?* Maps, places, hotspots and gradients.
- *With whom?* Relationships and connections between objects or people.
